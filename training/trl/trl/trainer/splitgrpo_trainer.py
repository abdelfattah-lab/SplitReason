...
# Replace this with SplitVLLMClient
# Simple changes needed there, it just has to interact with our SplitReason service
# we need to expose a 'update_named_params'
...
class SplitGRPOTrainer(Trainer):
    """
    ...
    from trl import SplitGRPOTrainer
    ...
    def _set_signature_columns_if_needed(self):
        ...
        # In SplitGRPOTrainer, we preprocess data, so using the model's signature columns doesn't work.
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        if return_outputs:
            raise ValueError("The SplitGRPOTrainer does not support returning outputs")
