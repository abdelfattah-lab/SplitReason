...
# Foreground Training for GRPO
CUDA_VISIBLE_DEVICES=2 ACCELERATE_LOG_LEVEL=info \
    accelerate launch --main_process_port 29507 --config_file recipes/accelerate_configs/zero2.yaml --num_processes 1 \
