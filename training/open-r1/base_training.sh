...
#     src/open_r1/grpo.py --config recipes/DeepSeek-R1-Distill-Qwen-1.5B/grpo/config_demo.yaml --wandb_project distilqwen_15b_9k --run_name Qwen-1.5B-GRPO-SpecReason
