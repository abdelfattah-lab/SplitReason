...
# python -m lm_eval --model vllm_speculative --model_args "service_script_path=./spec_service.py,small_model_only=True,big_model=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,small_model=akhauriyash/DDR1_Q1.5B-GRPOFixReward,max_tokens=16384,big_model_gpus=0|1,small_model_gpus=2,pretrained=meta-llama/Llama-2-7b-chat-hf"  \
#      --tasks aime24_nofigures --batch_size auto --apply_chat_template  --output_path log_traces/Jan22_modelonly --log_samples --gen_kwargs "max_gen_toks=16384,thinking_start=\n<think>,thinking_end=\n</think>" 

python -m lm_eval --model vllm_speculative --model_args "service_script_path=./spec_service.py,spec_reason_perf=True,big_model=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,small_model=akhauriyash/DDR1_Q1.5B-GRPOFixReward,max_tokens=16384,big_model_gpus=0|1|2|3,small_model_gpus=4|5|6|7,pretrained=meta-llama/Llama-2-7b-chat-hf,big_model_port=8002,small_model_port=8004,speculative_reasoner_port=5002"  \
     --tasks aime24_nofigures --batch_size auto --apply_chat_template  --output_path log_traces/Jan22_e2eGRPOv2 --log_samples --gen_kwargs "max_gen_toks=16384,thinking_start=\n<think>,thinking_end=\n</think>"  

# python -m lm_eval --model vllm_speculative --model_args "service_script_path=./spec_service.py,spec_reason_perf=True,big_model=deepseek-ai/DeepSeek-R1-Distill-Qwen-14B,small_model=akhauriyash/DDR1_Q1.5B-GRPOFixReward,max_tokens=16384,big_model_gpus=0,small_model_gpus=1,pretrained=meta-llama/Llama-2-7b-chat-hf,big_model_port=8002,small_model_port=8004,port=5002"  \
#      --tasks aime24_nofigures --batch_size auto --apply_chat_template  --output_path log_traces/28Nov_NewModel_e2egrpo_8b_v2 --log_samples --gen_kwargs "max_gen_toks=16384,thinking_start=\n<think>,thinking_end=\n</think>"  
