...
python -m lm_eval --model vllm_speculative \
  --model_args "service_script_path=./spec_service.py,pretrained=meta-llama/Llama-2-7b-chat-hf,big_model=deepseek-ai/DeepSeek-R1-Distill-Qwen-7B,big_model_port=8000,big_model_gpus=0,small_model=deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B,small_model_port=8001,small_model_gpus=1,max_tokens=16384,stok=512,sgen=32,sdecay=2,ltok=32,lbound=8,logprob_subselect=True" \
  --tasks aime24_nofigures --batch_size auto --apply_chat_template  --output_path log_traces/lprob_7b_15b_512_32_2_32_2 --log_samples --gen_kwargs "max_gen_toks=16384,thinking_start=\n<think>,thinking_end=\n</think>" 
