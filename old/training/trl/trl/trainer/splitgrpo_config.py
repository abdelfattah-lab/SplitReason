...
@dataclass
class SplitGRPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`SplitGRPOTrainer`].

    Only the parameters specific to SplitGRPO training are listed here. For details on other parameters, refer to the
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`SplitGRPOTrainer`] is provided as a string.
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. SplitGRPO](https://github.com/sail-sg/understand-r1-zero/blob/main/understand-r1-zero.pdf)
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in SplitGRPO we usually rely on
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. SplitGRPO paper recommends not scaling the rewards, as scaling by the standard "
